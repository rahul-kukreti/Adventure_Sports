...
public class Login_ObjectPage extends BaseClass {
	...
	public void LoginSucess(WebDriver driver) throws InterruptedException {
		Thread.sleep(4000);
		if (driver.findElements(By.xpath("//div[contains(@class,'dashboard_title')]")).size()!= 0) {
			System.out.println("Login successfull!");
		} else {
			System.err.println("Something went wrong in login!");
		}
	}
}
